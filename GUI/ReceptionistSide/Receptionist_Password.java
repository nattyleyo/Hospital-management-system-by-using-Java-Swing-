 ...
 * @author HP
 */
public class Receptionist_Password extends javax.swing.JPanel {
     ...
     */
    public Receptionist_Password() {
        initComponents();
        receptionistIdtextField.setEditable(false);    
        receptionistIdtextField.setText(LoginPanel.logedPesonID);
    }
    ...
    private void initComponents() {
        ...
        receptionistIdtextField = new javax.swing.JTextField();
        ...
        panel8.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 50, 80, 20));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(51, 0, 0));
        jLabel6.setText("Confirm");
        panel8.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 210, 70, 20));

        panel12.setBackground(new java.awt.Color(247, 247, 247));
        panel12.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        receptionistIdtextField.setEditable(false);
        receptionistIdtextField.setBackground(new java.awt.Color(247, 247, 247));
        receptionistIdtextField.setForeground(new java.awt.Color(51, 51, 51));
        receptionistIdtextField.setBorder(null);
        receptionistIdtextField.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        receptionistIdtextField.setOpaque(true);
        panel12.add(receptionistIdtextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 0, 300, 40));

        panel8.add(panel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 340, 40));
        ...
        panel8.add(panel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 240, 340, 40));
        ...
        panel8.add(panel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, 340, 40));

        jLabel10.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(51, 0, 0));
        jLabel10.setText("Password");
        panel8.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 80, 20));

        content.add(panel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 280, 420, 420));

        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/reception (2).png"))); // NOI18N
    ...
    private javax.swing.JTextField receptionistIdtextField;
